...
describe("World Engine Workbench preview redesign", () => {
    it("保留 mock 数据源和三栏 preview 入口", async () => {
        ...
        expect(page).toContain("inspectorVisible = true");
        ...
        expect(sidebar).toContain("const calendarSourcePath = \"world-engine/calendar.yaml\";");
        ...
        expect(inspector).toContain("order-6 space-y-2");
        expect(inspector).not.toContain("order-7 space-y-2");
